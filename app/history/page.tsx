          ...
          <CardContent>
            {history.length === 0 ? (
              <div className="text-center py-12">
                <Clock className="h-16 w-16 text-gray-900 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-white mb-2">ไม่มีประวัติการยืม</h3>
                <p className="text-gray-300 mb-4">คุณยังไม่เคยยืมอุปกรณ์กีฬา</p>
                <Link href="/equipment">
                  <Button>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <Card>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg">ยืมอยู่</CardTitle>
              </CardHeader>
            </Card>
          </div>
        )}
